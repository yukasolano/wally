...
public class ProdutoController {
	...
	@PostMapping(value = "produtos/arquivo-renda-fixa/download")
	public ResponseEntity exportaArquivoRF() {
		ExportedFile resource = fileExporterResolver.resolve(TypeFile.INVESTIMENTOS, null).export();
	...
	@PostMapping(value = "produtos/arquivo-renda-variavel/download")
	public ResponseEntity exportaArquivoRVF() {
		ExportedFile resource = fileExporterResolver.resolve(TypeFile.MOVIMENTOS, null).export();
	...
	public ResponseEntity exportaExtrato(@RequestBody List<MovimentacaoEntity> data) {
		ExportedFile resource = fileExporterResolver.resolve(TypeFile.GENERICO, data).export();
